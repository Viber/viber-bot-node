...
exports.messageFactory = {
	...
	testBuildContactMessageSanity: test => {
		...
		test.deepEqual(message.toJson(), { type: 'contact', contact: { name: 'idan', "phone_number": '97245611234' } });
		test.done();
	},
	...
	testBuildVideoMessageSanity: test => {
		...
		test.deepEqual(message.toJson(), { type: 'video', media: 'http://viber.com', thumbnail: 'http://viber.com/thumb.png', size: 1234, duration: 123 });
		test.done();
	},
